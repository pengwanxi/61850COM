...
#ifndef  MODBUSCJZ9SY_N_INC
#define  MODBUSCJZ9SY__N_INC
...
* =====================================================================================
*/
class CModBusSCJZ9SY_N : public CProtocol_ModBusMaster
{
public:
	/* ====================  LIFECYCLE     ======================================= */
	CModBusSCJZ9SY_N();                             /* constructor      */
	~CModBusSCJZ9SY_N();                            /* destructor       */
...
}; /* -----  end of class CModBusSCJZ9SY_N  ----- */

#endif   /* ----- #ifndef MODBUSCJZ9SY__N_INC  ----- */
