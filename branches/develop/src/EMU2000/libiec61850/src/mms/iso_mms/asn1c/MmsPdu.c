...
asn_TYPE_descriptor_t asn_DEF_MmsPdu = {/*{{{*/									//asn_DEF_MmsPdu:结构体对象!
	"MmsPdu",
	"MmsPdu",
	CHOICE_free,
	CHOICE_print,
	CHOICE_constraint,
	CHOICE_decode_ber,								//BER:基本编码规则!			这几种编码方法是ASN.1(抽象语法标记1(Abstract Syntax Notation dotone))常用的编码方法!
	CHOICE_encode_der,								//DER:唯一编码规则!
	CHOICE_decode_xer,								//CER:规则编码方法!
	CHOICE_encode_xer,								//XER:XML编码方法!
