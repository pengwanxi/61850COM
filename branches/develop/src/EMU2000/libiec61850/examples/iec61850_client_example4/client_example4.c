...
{/*{{{*/
	...
	if (error == IED_ERROR_OK) {
		...
		LinkedList_add(newDataSetEntries, "BAY1LD0/CMMXU1.A[MX]");
		LinkedList_add(newDataSetEntries, "BAY1LD0/CMMXU1.B[MX]");
		LinkedList_add(newDataSetEntries, "BAY1LD0/CMMXU1.C[MX]");
		LinkedList_add(newDataSetEntries, "BAY1LD0/CMMXU1.D[MX]");

		IedConnection_createDataSet(con, &error, "BAY1LD0/LLN0.AnalogueValues", newDataSetEntries);
		...
		clientDataSet = IedConnection_readDataSetValues(con, &error, "BAY1LD0/LLN0.AnalogueValues", NULL);
		...
		IedConnection_deleteDataSet(con, &error, "BAY1LD0/LLN0.AnalogueValues");
