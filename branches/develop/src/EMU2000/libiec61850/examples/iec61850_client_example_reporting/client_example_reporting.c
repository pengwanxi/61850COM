...
{/*{{{*/
	...
	if (error == IED_ERROR_OK) {
		...
		LinkedList dataSetDirectory =
			...
			/*IedConnection_getDataSetDirectory(con, &error, "SampleIEDDevice1/LLN0.dataset1", NULL);*/
			IedConnection_getDataSetDirectory(con, &error, "BAY1LD0/LLN0.MeasFlt", NULL);
		...
		/*clientDataSet = IedConnection_readDataSetValues(con, &error, "SampleIEDDevice1/LLN0.dataset1", NULL);*/
		clientDataSet = IedConnection_readDataSetValues(con, &error, "BAY1LD0/LLN0.MeasFlt", NULL);
		...
		ClientReportControlBlock rcb =
			...
			/*IedConnection_getRCBValues(con, &error, "SampleIEDDevice1/LLN0.BR.LLN0_Events_BuffRep01", NULL);*/
			IedConnection_getRCBValues(con, &error, "BAY1LD0/LLN0.BR.rcbMeasFlt01", NULL);
		...
		/*ClientReportControlBlock_setDataSetReference(rcb, "SampleIEDDevice1/LLN0$dataset1"); [> NOTE the "$" instead of "." ! <]*/
		ClientReportControlBlock_setDataSetReference(rcb, "BAY1LD0/LLN0$MeasFlt"); /* NOTE the "$" instead of "." ! */
		...
		/*IedConnection_installReportHandler(con, "SampleIEDDevice1/LLN0.BR.LLN0_Events_BuffRep", ClientReportControlBlock_getRptId(rcb), reportCallbackFunction,*/
		IedConnection_installReportHandler(con, "BAY1LD0/LLN0.BR.rcbMeasFlt01", ClientReportControlBlock_getRptId(rcb), reportCallbackFunction,
		...
		IedConnection_setRCBValues(con, &error, rcb, RCB_ELEMENT_RESV | RCB_ELEMENT_RPT_ENA | RCB_ELEMENT_GI, true);
